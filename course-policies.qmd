...
:::{.callout-note}
You must pass the examination with a score _greater than_ **60%** to pass the course.
...
- Late submissions (See [Information in "About"](./about.qmd#late-work-policy)).
