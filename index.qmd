...
:::{.callout-note}
### Syllabus
Link for the syllabus <a href="./media/CS1012_Spring_2024_Syllabus.pdf" download>**here**</a>.
:::

:::{.callout-note}
## Make-up Exam on 05/06/2024 (ONLY for students who Fail Exam on 04/15)
- **Make-up Exam on Monday, 05/06 (exam week)**
    - **This exam is offered ONLY to students who Fail the exam on 04/15**
    - **If you don’t appear for the Exam on 04/15, you will NOT be permitted to take the Make-up Exam** 
- **Location:** 1957 E street Room 213 
- **Duration:** 50 minutes; Start time: 5:20 PM
- **Paper exam**
    - Closed everything (no notes, no Thonny, no smart and handheld devices)
    - Multiple choice/ fill in the blanks/ write the output – similar to quizzes
    - You will be required to sign the Academic Integrity Pledge
    - **20 questions (no choice, 5 points each)**
    - **Total:** 100 points
- **Greater than 60 % needed to Pass the Make-up Exam and the course as per [Course Policy](./course-policies.qmd#assessments-and-grading)**
- **Exam Score if you pass** 
    - Will NOT be higher than the lowest grade of the students who passed the exam on 04/15
    - Will be in accordance with the [grading-policy and -scale](course-policies.qmd) outlined in the course.
    - The Final grade if you pass will be in accordance with the [grading-policy and scale](course-policies.qmd) outlined inthe course
:::

:::{.callout-note}
## Exam on 04/15/2024 (Mandatory for all students-no exceptions) (Completed)
- **Exam on Monday, 04/15 will be held during the lecture.**
- **Location:** 1957 E street Room 213 
- **Duration:** 60 minutes 
- **Start time:** 3:45 PM
- **Paper exam**
    ...
    - You will be required to sign the Academic Integrity Pledge
    - **25 questions**
        - Answer as many as you can; Up to 20 correct answers will be graded for 5 points each
    -  **Total:** 100 points
- **Greater than 60 % needed to Pass the Exam and the course as per [Course Policy](./course-policies.qmd#assessments-and-grading)**
- **Exam Score will be according to the [grading-policy and scale](course-policies.qmd) outlined inthe course**
:::

:::{.callout-important}
Unit 2-Module 2 is not covered in the course. 
You may choose to browse through it and just get familiar with some advanced topics presented therein. 
There is no deliverable from Unit 2-Module 2.
:::
