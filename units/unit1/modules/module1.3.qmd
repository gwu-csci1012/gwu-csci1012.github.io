...
<div class="breadcrumbs">
  ...
  <span class="current-page">Module 1.3</span>
</div>
...
print(e)
```
:::{.callout-caution appearance="simple" icon=false title="**1.3.1 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.2 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.4 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.6 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.8 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.9 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.10 Exercise**"}
Use the list 
```python
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.11 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.12 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.13 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.15 Exercise**"}
First, trace through the above in your module pdf. Then, type it up in `my_search_negative.py` and confirm.
:::


:::{.callout-caution appearance="simple" icon=false title="**1.3.16 Exercise**"}
...
## 1.3.4 New topic: strings and slicing
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.18 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.19 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.20 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.21 Exercise**"}
Does it work? Trace the execution of the above in your module pdf before typing it up in `my_prefix.py` to see.
:::

:::{.callout-caution appearance="simple" icon=false title="**1.3.22 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.24 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.25 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.26 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.27 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.28 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.29 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.30 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.31 Exercise**"}
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.33 Exercise**"}
```python
def is_odd(k):
    if k % 2 == 1:
        return true
...
:::{.callout-caution appearance="simple" icon=false title="**1.3.34 Exercise**"}
```python
x = 4
if x >= 0 and <= 5:
