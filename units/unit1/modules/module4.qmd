...
- **Save your program as `my_nested_loop3.py` and submit it.**
...
- **Download and examine the file <a href="../../../media/units/unit1/module1.4/data2.txt">data2.txt**</a> in a text editor.
...
- **Type up the above in `my_file_data2.py`.** 
  - You should have already downloaded the file <a href="../../../media/units/unit1/module1.4/data2.txt">data2.txt</a>  in the same folder.
