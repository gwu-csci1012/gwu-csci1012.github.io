...
:::{.callout-caution appearance="simple" icon=false}
### Exercise 1.23
Type up the above program in `my_listcheck.py`, run it for the following inputs when prompted at the shell or console; examine the output in each case:
...
Submit the program with the case suggested in point #3. 
:::
