...
1. Below the print with `Hey, x is bigger` add another print-statement to print the text. For example, you can add a line such as, 'Hey, y is smaller'. Make sure the new print-statement is indented i.e., it is have 4 spaces preceding it.
2. Run the program and to make sure you are getting the outputs you programmed.
3. Now change the value of y to 6 and see for yourself if you are getting a different output.
4. Submit the program with modifications in in point #1 and #3.
:::
...
The following part of the exercise is not required for submission. However, it is important for you to complete it on your own to understand the working of the program `my_ifexample2.py`. 

- Trace through the program above using a table in a spreadsheet or a document

    - Track the variables i and s and, the print-statements to confirm the output of the program.
:::
...
1. Notice that in the first line of the variable x is assigned the value 3.  
2. Run the program again after changing the variable assigment in the first line of the program each time to x = 1, x = 2, x = 4 and x = 5 and examine the output.
3. Submit the program `my_ifexample5.py` with x = 3. 

The following part of the exercise is not required for submission. However, it will help you understand how elif-construct works
...
1. Change the variable assigment y to 6, and run the program to examine the output.
2. Change the variable assigment y to 4 and submit the program.
...
The following part of the exercise is not required for submission. However, it will help you understand how the nestedif-construct works.
...
4. Submit the program with modification in point #3. 
:::
...
Then do the following: try a=0.5.

1. Chnage the value of a to 0.5 and run the program to examine the output.
2. Submit the program with the modification in point #1.
:::
...
1. Change z to be 6 (same as y) and observe the output.
2. Submit the program with the modification in point #1.
:::
...
- Then, write up a program `my_boolean4.py` with variables assignments, a=1, b=1, c=3, d=4 and e=5, to evaluate the above expressions. 
    - Use the print-statement with each of the expression to see the result. 

- Submit `my_boolean4.py`. 

- The following segment is not required for submission: 
    - Compare the result of your evaluation-by-hand with those of the program.
:::
...
b = -4
diff = abs(a-b) 
# Note: abs() is a Python in-built fucntion that returns 
# the absolute value of the specified number
print(diff)
```
**Note: `abs()` is a Python in-built fucntion that returns the absolute value of the specified number**

**Case-1:** Use conditionals to print out the absolute difference between the two numbers. Note: In the above case, the difference is 1. 

- **Hint**: Use logic operator, `>=` to print the variable `diff` . Use the code structure shown below that compares a variable to a value and prints the value when conditions are met.
...
:::{.callout-caution appearance="simple" icon=false}
### Exercise 1.18
Type up the above orogram in `my_oddeven.py`and run it to examine the output. Then do the following: 

1.  Modify the above program so that for every number between n and 1, including 1, going backwards, the program prints whether it's even or odd, as in:
```python
10 is even
9 is odd
8 is even
...
1 is odd
```
2. Submit the program with modification suggeested in point #1. 

3. The following part of the exercise is not required for submission: Trace through the interactions in the above program in a separate spreadsheet or document.
:::
...
- Type up the program below called `my_consecutive.py`, with loop and a conditional to identify such consecutive pairs and print them. 
...
:::{.callout-caution appearance="simple" icon=false}
### Exercise 1.23
Type up the above orogram in `my_listcheck.py`, run it for the following inputs when prompted at the shell or console; examine the output in each case:

1. 100
2. 35.364
3. 4 

Submit the program with the case suggeested in point #3. 
:::
...
Trace through the iterations in the above program and explain to yourself why it does not work.
...
:::{.callout-caution appearance="simple" icon=false}
### Exercise 1.26
Type up the above proream in `my_listcheck2.py` and submit it.

The following part of the exercise is not required for submission: 
Trace through the iterations in the above program and in a separate spreadsheet or document. Explain to youself the output and why does the inner loop start with i+1?
:::
...
Note: The theoretical answer is 0.0625 (approximately 6% chance there's no heads in 4 tosses).
2. Submit your program with modification suggested in point #1.
:::
...
- Run the program for the sum of the values of the dice is 12, i.e., roll1 + roll2 = 12
- Run the program for the sum of the values of the dice is 12, i.e., roll1 + roll2 = 2 
...
Then do the following two cases:
...
**Submit your program for Case-2**
...
1. Try it out and then examine the code to confirm that it follows the pseudocode. 

2. Try another value of n, i.e., n = 1000. You should an image like the one below.

    ![](../../../media/units/unit1/module1/Conditional_art1_2.png)

3. Change the choices of randomly chosen colors. Use `colors = ['c','m','y','k']` and the value of n = 1000.

4. Submit your program with the modifcation suggested in point #3. 
<!-- 
...
**Submit your program with parameters in Case-2**
