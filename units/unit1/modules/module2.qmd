...
**Submit your program `my_func_example5.py`.**
:::
...
- Execute the program `my_stats.py` and examine the output to check if the <em>mean</em>, <em>standard deviation</em> and <em>outliers</em> of the data are computed and printed.
