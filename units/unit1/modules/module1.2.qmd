...
Found even:  8
```
Recall how to use the <em>remainder</em> operator from the previous module (conditionals and loops).
:::
...
## 1.2.13 Incribed geometric figures as art
...
:::{.callout-caution appearance="simple" icon=false title="1.2.45 Exercise"}
```python
def find_smallest(A):
    smallest = 1000
    for k in A:
