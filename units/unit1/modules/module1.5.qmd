...
<div class="breadcrumbs">
  ...
  <span class="current-page">Module 1.5</span>
</div>
...
- A <em>name</em>, like `x` or `this_is_fun` above.
    <br>&nbsp;&nbsp;&nbsp;&nbsp;
	&rArr; Variable names don't change during execution, they are given by the programmer
- A current <em>value</em>. 
    <br>&nbsp;&nbsp;&nbsp;&nbsp;
	&rArr; At any moment during execution, a variable has a value.
    <br> This value can change (often does) during execution.
- A <em>scope</em>. More about this in Unit-2.
- A <em>type</em>, such as integer, float, string, Boolean, list (and there are a few more, an advanced topic).
...
:::{.callout-caution appearance="simple" icon=false title="1.5.1 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="1.5.2 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="1.5.3 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="1.5.4 Exercise"}
Examine and mentally execute the following:
```python
A = [-1, 2, 3, -5, 6, 7]
...
:::{.callout-caution appearance="simple" icon=false title="1.5.6 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="1.5.8 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="1.5.10 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="1.5.11 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="1.5.12 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="1.5.13 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="1.5.14 Exercise"}
...
with 
    ...
    print(mean(Y))
    ```
3. The second big reason is <i>composability</i>, as this example shows:
