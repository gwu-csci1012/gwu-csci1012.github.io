...
- **Step 1**: [Install Thonny for Mac](thonny-mac.qmd)

- **Step 2**: [Install Spyder for Mac](spyder-mac.qmd)

#### **Windows:**

- **Step 1**: [Install Thonny for Windows](thonny-windows.qmd)

- **Step 2**: [Install Spyder for Windows](spyder-windows.qmd)
