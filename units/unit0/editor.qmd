...
- *Option A*: [Thonny for Mac users](editor.qmd#install-thonny-mac)
- *Option B*: There are no special instructions because Spyder comes bundled with Anaconda.
- *Option A*: [Thonny for Windows users](editor.qmd#install-thonny-windows)
- *Option B*: There are no special instructions because Spyder comes bundled with Anaconda.
...
- *Option A*: [Helloworld for Mac users using Thonny](editor.qmd#hello-thonny-mac)
- *Option B*: [Helloworld for Mac users using Spyder](editor.qmd#hello-spyder-mac)
- *Option A*: [Helloworld for Windows users using Thonny](editor.qmd#hello-thonny-win)
- *Option B*: [Helloworld for Windows users using Spyder](editor.qmd#hello-spyder-win)
...
- Mac Users: [Install matplotlib for Thonny](editor.qmd#install-matplotlib-mac)
- Windows Users: [Install matplotlib for Thonny](editor.qmd#install-matplotlib-win)
...
{{< video ../../media/units/unit0/module0/u0-mod0-installthonny-mac.mp4 aspect-ratio="21x9" >}}
Now click on the [**Link to Thonny**](https://thonny.org) and install it on your laptop.
...
{{< video  ../../media/units/unit0/module0/u0-mod0-mac-thonny.mp4 aspect-ratio="21x9" >}}

<div id="hello-spyder-mac"></div>
### Step 4: Option B, Helloworld in Spyder
{{< video  ../../media/units/unit0/module0/u0-mod0-mac-spyder.mp4 aspect-ratio="21x9" >}}
...
<div id="install-thonny-windows"></div>
### Step 2: Option A, Installing Thonny
Installing and Opening Thonny
{{< video ../../media/units/unit0/module0/u0-mod0-installthonny-win.mp4 aspect-ratio="21x9" >}}
Now click on the [**Link to Thonny**](https://thonny.org) and install it on your laptop.
...
### Step 4: Option A, Helloworld in Thonny
{{< video ../../media/units/unit0/module0/u0-mod0-win-spyder.mp4 aspect-ratio="21x9" >}}
