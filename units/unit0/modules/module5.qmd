...
###### <span style="color:#8B4513;">**5.23 Excercise:** Type up the above in `my_char_example3.py`. What does it print? What is the significance of the number 123?</span>
...
###### <span style="color:#8B4513;">**5.24 Excercise:** Let's see what can go wrong if we use one of the words "already taken". Consider this program:</span>
```python
s = 'Hello'
...
###### <span style="color:#8B4513;">**5.26 Excercise:** Confirm by typing up the above in `my_letter_count.py`.</span>
...
###### <span style="color:#8B4513;">**5.27 Excercise:** Type up the above idea `my_count_problem.py`. Then, find another pangram and apply the program to that pangram. Submit your program with the pangram shown above (not the one you found).</span>

###### <span style="color:#8B4513;">**5.28 Excercise:** This can be taken a step further. Instead of typing the pangram in the program itself (as was done above), ask the user to enter it as input. In `my_count_problem2.py`, read a string from the user and print the letter counts. When you test your program, use the pangram you found as input.</span>
