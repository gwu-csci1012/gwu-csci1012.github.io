...
<div class="breadcrumbs">
  ...
  <span class="current-page">Module 0.1
</div>
...
:::{.callout-caution appearance="simple" icon=false title="0.1.1 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.1.2 Exercise"}
Write up the above in `comment_error.py`. Remember to save the file (and do this for every exercise in the future that involves a program). What is the error displayed when you try to run the program? Write the error in your `module0.1.pdf` file.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.1.3 Exercise"} 
Write up the above in `whitespace_example.py`. Does the program run? Write your answer in `module0.1.pdf` file. Remember: if it's not clear where to write your answer, write it in your module pdf (for this module that's `module0.1.pdf`)
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.1.4 Exercise"}
Write up the above in `whitespace_example2.py`. What is the error produced?
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.1.5 Exercise"}
Write up the above in `whitespace_example3.py`. What is printed out? Write your answer in `module0.1.pdf`
:::
...
print("World!") 
```
:::{.callout-caution appearance="simple" icon=false title="0.1.6 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.1.7 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.1.8 Exercise"}
Write up the above `my_string_example3.py`. What is the output? Write your answer in `module0.1.pdf`
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.1.9 Exercise"}
...
```
:::{.callout-caution appearance="simple" icon=false title="0.1.11 Exercise"}
Write a program called `my_string_example4.py` with the above program and run it. What is the error you observe? Write your answer in `module0.1.pdf`
:::
...
I’m never sure. Are you?''')
```
:::{.callout-caution appearance="simple" icon=false title="0.1.12 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.1.13 Exercise"}
Write up the above program in `case_error.py` and run it. What is the error you get? Write your answer in `module0.1.pdf`.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.1.14 Exercise"}
...
window.mainloop()
```
:::{.callout-caution appearance="simple" icon=false title="0.1.15 Exercise"}
Write up the above program in `hello_gui.py` being careful to type it in exactly as shown above, paying attention to every keystroke. Run it to get something like: ![](../../../media/units/unit0/module1/hello-gui.png) If something went wrong with the typing, you can instead download <a href="../../../media/units/unit0/module1/hello_gui.py" download >**hello_gui.py**</a> but only after giving the typing a good try. 
:::
...
## 0.1.5 A reminder about computerese
