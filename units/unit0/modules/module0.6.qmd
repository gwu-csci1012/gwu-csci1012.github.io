...
<div class="breadcrumbs">
  ...
  <span class="current-page">Module 0.6
</div>
...
:::{.callout-caution appearance="simple" icon=false title="0.6.1 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.6.2 Exercise"}
Type up the above in `my_real_example2.py`. What is the output? Consider 2.56<sup>x</sup> = y. Can you guess what approximate value of x would make `y` become 400? Play around with the number 6.4 in the program above and see if you can guess approximately what value would make `y` become 400. 
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.6.3 Exercise"}
...
## 0.6.1 Going from reals to integers and strings
...
:::{.callout-caution appearance="simple" icon=false title="0.6.5 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.6.6 Exercise"}
What is the error in the above program? Now change the second statement from `y = x / 2` to `y = x * 2`. What do you see? Write your code in `my_real_example5.py`. Submit the version with `y = x / 2` but describe both cases in your module pdf.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.6.7 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.6.9 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.6.11 Exercise"}
Type up the above in `my_compound_interest.py`. What is the final amount printed? In your module pdf, trace through the iterations above using a table, tracking the variables `year, amount, interest`.
:::

Let's point out:
![](../../../media/units/unit0/module6/real3.png)

:::{.callout-caution appearance="simple" icon=false title="0.6.12 Exercise"}
...
## 0.6.3 Some Greek history via programming
Zeno's paradox:
...
:::{.callout-caution appearance="simple" icon=false title="0.6.14 Exercise"}
Type up the above in `my_zeno.py`. In your module pdf trace through the values of each of the variables.
:::

:::{.callout-caution appearance="simple" icon=false title="0.6.15 Exercise"}
Type up the above in `my_zeno.py`. In your module pdf trace through the values of each of the variables.
...
## 0.6.4 A statistical application
...
:::{.callout-caution appearance="simple" icon=false title="0.6.16 Exercise"}
Type up the above in `my_stats1.py`. What is the average?
:::

:::{.callout-caution appearance="simple" icon=false title="0.6.17 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.6.18 Exercise"}
Fill in the missing line and write up the program in `my_stats3.py`. You will need to download <a href="../../../media/useful/wordtool.py" download >**wordtool.py**</a> and <a href="../../../media/useful/wordsWithPOS.txt" download>**wordsWithPOS.txt**</a>.
:::

:::{.callout-caution appearance="simple" icon=false title="0.6.19 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.6.20 Exercise"}
Use a scientific calculator (included in every laptop) to calculate the sin values for the 20 input values beginning with 0, 0.5, 1, ... etc .. until 10. Then plot this by hand on paper and include a picture in your module pdf.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.6.22 Exercise"}
...
## 0.6.6 Plotting a curve with data
...
:::{.callout-caution appearance="simple" icon=false title="0.6.23 Exercise"}
You already have <a href="../../../media/useful/drawtool.py" download >**drawtool.py**</a> in your module6 folder. Type up the above in `my_dataplot.py` and run. Do you see the points "sort of" along a jagged line? This is actual scientific data from observations made in 1929. It utterly shattered our perception of the world. Can you identify what this was about and explain the significance?
:::

## 0.6.7 When things go wrong
...
:::{.callout-caution appearance="simple" icon=false title="0.6.24 Exercise"}
```python
x = 2 *** 6
print(x)
```
...
:::{.callout-caution appearance="simple" icon=false title="0.6.25 Exercise"}
```python
x = 100
y = 0.1 * x
print('y=' + y)
...
:::{.callout-caution appearance="simple" icon=false title="0.6.26 Exercise"}
```python
import math
...
:::{.callout-caution appearance="simple" icon=false title="0.6.27 Exercise"}
```python
...
## 0.6.8 About the reals, and math in general
