...
###### <span style="color:#8B4513;">**6.21 Excercise:** Download <a href="../../../media/useful/drawtool.py" download >**drawtool.py**</a> into your module6 folder. Then type up the above in `my_functionplot.py` and execute. Change `N` to 100. This should produce a smoother curve. Next, change the statement </span>
```python
for k in range(0, N):
```
to
...
###### <span style="color:#8B4513;">**6.23 Excercise:**</span>
