...
:::{.callout-tip}
[**Instructor's video lectures**](../../additional-resources/insructor-notes/week-5.qmd)
:::
...
m = math.floor()
n = math.ceil()
print('Rounding down x gives ' + str(m))
print('Rounding up x gives ' + str(n))
```
:::
...
- There is an error in the above program that should be fixed. Fix it and make sure you program is running correctly.
- Don't submit it yet. 
- Add a few lines of code to print the output of `y = x * 2`. What do you see? Write your code in `my_real_example5.py`. 
- You should complete the additional lines of the code required in this exercise, and run the program to make sure you are getting the output desired. 
...
- To confirm your output can you calculate the final amount printed?- Trace through the iterations above using a table in a spreadsheet or a document, tracking the variables year, amount, interest.
- The tracing exercise need to be submitted in this exercise.
:::
...
Fill in the missing line and write up the program in `my_stats3.py`. 

- You will need to download <a href="../../../media/useful/wordtool.py" download >**wordtool.py**</a> and <a href="../../../media/useful/wordsWithPOS.txt" download>**wordsWithPOS.txt**</a>.
...
In `my_stats4.py`, modify the above to estimate the average length of verbs. 

- Compare the average length of nouns to the average length of verbs. 
- Check if n = 10 is enough of a random sample in your program. 
- Submit `my_stats4.py` with n = 10.
- Try higher values of n to get some understanding of what should n be to feel assured that you have a sound comparison.
