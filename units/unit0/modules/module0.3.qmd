...
<div class="breadcrumbs">
  ...
  <span class="current-page">Module 0.3
</div>
...
for i in range(6):
    print_big_O()
```
:::{.callout-caution appearance="simple" icon=false title="0.3.1 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.3.2 Exercise"}
...
for i in range(6):
    print(i)
```
:::{.callout-caution appearance="simple" icon=false title="0.3.3 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.3.4 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.3.6 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.3.7 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.3.8 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.3.10 Exercise"}
Add a row for `5` (with five of them), writing your code in `my_forloop_print.py`.
:::

:::{.callout-caution appearance="simple" icon=false title="0.3.11 Exercise"}
Just for the heck of it, could one use a for-loop to achieve the printing of `1` all by itself? That is, answer the question in your module pdf: can a for-loop be set up so that you go into it exactly once? Write your code in `my_forloop_print2.py`.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.3.13 Exercise"}
...
## 0.3.3 Tracing through a program in detail
...
:::{.callout-caution appearance="simple" icon=false title="0.3.14 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.3.16 Exercise"}
Consider this program:
...
:::{.callout-caution appearance="simple" icon=false title="0.3.17 Exercise"}
Consider this program:
...
:::{.callout-caution appearance="simple" icon=false title="0.3.19 Exercise"}
Write up the above in `my_simpleloop.py` and run to see the output. Then in `module3.pdf`, trace the execution of the program.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.3.20 Exercise"}
What does it print? Try to figure this out by mental execution first. Then, type it up, compile and execute to confirm, writing your code in `my_execution_exercise.py`. Then in `module3.pdf`, trace the execution of the program.
:::

###### **0.3.21 Video** 
{{< video ../../../media/units/unit0/module3/u0-mod3.21.mp4 aspect-ratio="21x9" >}}

## 0.3.5 When things go wrong
...
:::{.callout-caution appearance="simple" icon=false title="0.3.22 Exercise"}
```python
for i in range(0 6):
    print(i)
```
...
:::{.callout-caution appearance="simple" icon=false title="0.3.23 Exercise"}
```python
for i in range(0, 6)
    print(i)
```
...
:::{.callout-caution appearance="simple" icon=false title="0.3.24 Exercise"}
```python
for i in range(0, 6:
    print(i)
```
...
:::{.callout-caution appearance="simple" icon=false title="0.3.25 Exercise"}
```python
for i in range(0, 6):
print(i)
```
...
:::{.callout-caution appearance="simple" icon=false title="0.3.26 Exercise"}
```python
for in range(0, 6):
    print(i)
```
...
:::{.callout-caution appearance="simple" icon=false title="0.3.27 Exercise"}
```python
for i in range(0, 6):
    print i
```
...
:::{.callout-caution appearance="simple" icon=false title="0.3.28 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.3.29 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.3.30 Exercise"}
...
## 0.3.7 &nbsp;&nbsp; Some things to keep mind
