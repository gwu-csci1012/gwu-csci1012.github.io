...
<div class="breadcrumbs">
  ...
  <span class="current-page">Module 0.5
</div>
...
:::{.callout-caution appearance="simple" icon=false title="0.5.1 Exercise"}
Type up the above in `my_string_example.py`. What is the printed length? Remember, answers to non-coding questions like this need to be in the appropriate module pdf, in this case `module5.pdf`.
:::

## 0.5.1 String concatenation
...
:::{.callout-caution appearance="simple" icon=false title="0.5.2 Exercise"}
Type up the above in `my_string_example2.py`. What is the output?
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.5.3 Exercise"}
Type up the above in `my_string_example3.py`. What is the output? How many times did a concatenation occur?
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.5.4 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.5 Exercise"}
...
## 0.5.2 Fun with string concatenation
...
:::{.callout-caution appearance="simple" icon=false title="0.5.8 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.10 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.11 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.12 Exercise"}
Try out a conversation with a chatbot. For example, one of the earliest chatbots in history was <a href="https://en.wikipedia.org/wiki/ELIZA">Eliza</a>, which <a href="http://www.masswerk.at/elizabot/">you can try out</a>. Report (with a screenshot in your module pdf) a sample conversation with Eliza.
:::

## 0.5.4 Strings and for-loops
Consider this program:
```python
n = 6
s = ''
...
:::{.callout-caution appearance="simple" icon=false title="0.5.13 Exercise"}
Before typing up the program, trace (in `module5.pdf`) the execution of the loop, showing the contents of the string `s` in each iteration of the for-loop. Then confirm the final output in your trace by typing it up in `my_loop_example.py`. Then change the value of `n` to 8 and examine the output. Submit your program with n set to 8.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.5.14 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.16 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.17 Exercise"}
Trace (using a table) through what happens above when the user enters 5.
:::

:::{.callout-caution appearance="simple" icon=false title="0.5.18 Exercise"}
...
## 0.5.5 The useful relationship between characters and integers
...
:::{.callout-caution appearance="simple" icon=false title="0.5.20 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.21 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.23 Exercise"}
...
## 0.5.7 A problem solving example
...
:::{.callout-caution appearance="simple" icon=false title="0.5.25 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.26 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.27 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.5.30 Exercise"}
```python
x = 'Hello'
y = 'World'
s = 'x' + ' ' + 'y'
...
:::{.callout-caution appearance="simple" icon=false title="0.5.31 Exercise"}
```python
k = 8
...
:::{.callout-caution appearance="simple" icon=false title="0.5.32 Exercise"}
```python
...
:::{.callout-caution appearance="simple" icon=false title="0.5.33 Exercise"}
```python
...
:::{.callout-caution appearance="simple" icon=false title="0.5.34 Exercise"}
```python
for i in range(1, 6):
    s = s + '**'
print(s)
...
:::{.callout-caution appearance="simple" icon=false title="0.5.35 Exercise"}
```python
miles = 10
feet per mile = 5280
