...
:::{.callout-tip}
[**Instructor's lecture slide deck**](../../additional-resources/insructor-notes/week-3.qmd)
:::

<!-- #### **Lecture video for `for-loop` with tracing**
{{< video ../../../media/units/unit0/module4/Tracing_Demo1_SumOfIntegers.mov aspect-ratio="21x9" >}} -->
