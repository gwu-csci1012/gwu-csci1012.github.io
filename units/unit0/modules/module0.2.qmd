...
<em>Before doing this exercise</em>, please [**read this page**](../guides/stopping.qmd) on how to  stop endlessly running programs. Now, type up and execute the above program in `my_strange_example.py`. Use comments (text followed by ‘#’ symbol) to describe the error if any in the python-file.
:::
