...
<div class="breadcrumbs">
  ...
  <span class="current-page">Module 0.2
</div>
...
## 0.2.0 An example with function calls
...
:::{.callout-caution appearance="simple" icon=false title="0.2.1 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.2.3 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.2.4 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.2.5 Exercise"}
Type up the above in `animal_sounds2.py` and run it.
:::
...
## 0.2.1 Calling functions from other functions
...
:::{.callout-caution appearance="simple" icon=false title="0.2.7 Exercise"}
Type up the above in `animal_sounds2.py` and run it.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.2.10 Exercise"}
Implement the above in `name_clash.py` and describe what happens in `module2.pdf`.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.2.11 Exercise"}
Describe in your module pdf how the output would be different, first without typing up the program, and then typing it up in `animal_sounds3.py`.
:::

## 0.2.3 A peek at the future
...
:::{.callout-caution appearance="simple" icon=false title="0.2.12 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.2.13 Exercise"}
...
## 0.2.4 And now for something strange
...
:::{.callout-caution appearance="simple" icon=false title="0.2.15 Exercise"}
Mentally execute the above program. That is, without typing it up, try to follow how the program executes, step by step Which statement gets executed in the 10-th step of execution? Do you notice anything unusual at step 13?  As a result, what line is executed in step 15? Write your answer in your module pdf (`module2.pdf`).
:::

:::{.callout-caution appearance="simple" icon=false title="0.2.16 Exercise"}
<em>Before doing this exercise</em>, please <b><a href="stopping.html">read this page</a></b> on how to  stop endlessly running programs. Now, type up and execute the above program in `my_strange_example.py`. What do you notice? (Or you might get an "recursion depth exceeded" error.)
:::
...
## 0.2.5 Another reminder about computerese
