...
<div class="breadcrumbs">
  ...
  <span class="current-page">Module 0.4</span>
</div>
...
Watch the video above and try a few other values of n, e.g., n = 3 or n =4. Try to guess the mathematical formula for 1 + 2<sup>1</sup> + 2<sup>2</sup> + 2<sup>3</sup> + ... + 2<sup>n</sup>
:::
