...
<div class="breadcrumbs">
  ...
  <span class="current-page">Module 0.4
</div>
...
print(i)
```
:::{.callout-caution appearance="simple" icon=false title="0.4.1 Exercise"}
Type up the program in `my_variable_example.py`. Also save the file so that it can be submitted (Remember: you need to save the appropriate files for every such "type up" exercise). What does it print? Report what you see in `module4.pdf`.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.4.2 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.4.3 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.4.4 Exercise"}
Consider this program:
...
:::{.callout-caution appearance="simple" icon=false title="0.4.5 Exercise"}
Consider this program:
...
:::{.callout-caution appearance="simple" icon=false title="0.4.6 Exercise"}
Consider this program:
```python
i = 5
j = i
...
:::{.callout-caution appearance="simple" icon=false title="0.4.8 Exercise"}
Consider this program:
...
:::{.callout-caution appearance="simple" icon=false title="0.4.10 Exercise"}
Type up the above in `my_variable_example8.py`. What is the value of n printed? Change i to 21. What is the value of n printed? Answer in `module4.pdf`. Submit your code with i set to 5.
:::
...
## 0.4.3 Expressions and operator-precedence
...
:::{.callout-caution appearance="simple" icon=false title="0.4.11 Exercise"}
Type up the above program in `my_expression_example.py`. What does it print? Answer in `module4.pdf`.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.4.12 Exercise"}
What does the expression `i*j - i+1*j-1` evaluate to when `i=7` and `j=3`? Answer in `module4.pdf`.
:::

###### **0.4.13 Video**
{{< video ../../../media/units/unit0/module4/u0-mod4.13.mp4 aspect-ratio="21x9" >}}

## 0.4.4 More about expressions and assignment
...
:::{.callout-caution appearance="simple" icon=false title="0.4.14 Exercise"}
Can you mentally execute and identify what's printed? Type up the above in `my_expression_example2.py` to confirm. Report the value in `module4.pdf`.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.4.15 Exercise"}
Can you mentally execute and identify what's printed? Type up the above in `my_expression_example3.py` to confirm. Then change j to 11 and run the program. Report the output in each case in `module4.pdf`. When submitting the code, leave j as 11.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.4.17 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.4.18 Exercise"}
Trace (in `module4.pdf`) the values of `i` and `s` in the program above. Then, in `my_expression_example4.py`, edit the code to create an outer loop that varies N from 1 to 10. That is, make N a new for-loop variable that ranges between 1 and 10 (inclusive), and ensure that you properly indent the inner (nested) loop that uses i. What pattern do you observe in the output?
:::

###### **0.4.19 Video**
{{< video ../../../media/units/unit0/module4/u0-mod4.19.mp4 aspect-ratio="21x9" >}}

## 0.4.5 Problem solving and pseudocode
...
:::{.callout-caution appearance="simple" icon=false title="0.4.20 Exercise"}
Trace (in `module4.pdf`) the values of `i` and `k` in the program above. This is what you should be able to domentally during mental execution.
:::

## 0.4.6 A problem-solving example with variables and nested for-loops
...
:::{.callout-caution appearance="simple" icon=false title="0.4.21 Exercise"}
Trace the changing values of `p` in the above program using a table (in `module4.pdf`). Then, type up the above program in `my_powerof2.py` to confirm.
:::
...
:::{.callout-caution appearance="simple" icon=false title="0.4.23 Exercise"}
Make a table with columns labeled `k, i, p` and `s` and trace the program, filling in the table step-by-step (in `module4.pdf`).
:::

###### **0.4.24 Video:**
{{< video ../../../media/units/unit0/module4/u0-mod4.24.mp4 aspect-ratio="21x9" >}}

:::{.callout-caution appearance="simple" icon=false title="0.4.25 Exercise"}
Try a few other values of `n`, e.g., `n=3` or `n=4`. Try to guess the mathematical formula for 1 + 2<sup>1</sup> + 2<sup>2</sup> + 2<sup>3</sup> + ... + 2<sup>n</sup> (in `module4.pdf`)
:::
...
d /= 2         # Same as d = d / 2
```
:::{.callout-caution appearance="simple" icon=false title="0.4.26 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.4.27 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="0.4.28 Exercise"}
What is the error in this program?
```python
i = 4
j = 3
...
:::{.callout-caution appearance="simple" icon=false title="0.4.29 Exercise"}
...
## 0.4.9 Python files vs module pdf
**Important:**
...
:::{.callout-caution appearance="simple" icon=false title="0.4.30 Exercise"}
