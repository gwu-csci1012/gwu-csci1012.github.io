...
- `my_geometric_art4.py` should output an image with 1000 circles filled with green color and (say) 100 rectangles, not-filled and outlined in blue color. 

- In `my_geometric_art4.py`, you may choose to draw a higher number of rectangles such as 500 or 1000. 

- We are only looking for a working program i.e., `my_geometric_art4.py`.
...
- After completing the all problems in this assignment, make a `zip` of the directory as `assignment1.zip` and submit it on Blackboard.
:::
