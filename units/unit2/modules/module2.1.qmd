---
title: "**Module 2.1:** Assorted Advanced Topics"
format:
  html:
    code-copy: false
---
...
<div class="breadcrumbs">
  ...
  <span class="current-page">Module 2.1</span>
</div>

## Objectives
The goal of this module is to touch upon a few advanced topics that will be directly useful in the next module.
...
:::{.callout-caution appearance="simple" icon=false title="2.1.1 Exercise"}
Type up the above in `my_tuple_example.py`. Then trace through the iteration in your module pdf.
:::

:::{.callout-caution appearance="simple" icon=false title="2.1.2 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="2.1.4 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="2.1.5 Exercise"}
...
## 2.1.2 Advanced topic: dictionaries
...
:::{.callout-caution appearance="simple" icon=false title="2.1.6 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="2.1.7 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="2.1.8 Exercise"}
...
## 2.1.3 Advanced topic: global variables 
...
:::{.callout-caution appearance="simple" icon=false title="2.1.10 Exercise"}
...
## 2.1.4 Advanced topic: multiple files
...
:::{.callout-caution appearance="simple" icon=false title="2.1.11 Exercise"}
...
## 2.1.5 Advanced topic: string formatting and numbers
...
:::{.callout-caution appearance="simple" icon=false title="2.1.12 Exercise"}
...
:::{.callout-caution appearance="simple" icon=false title="2.1.13 Exercise"}
...
## 2.1.7 What else is there in Python?
