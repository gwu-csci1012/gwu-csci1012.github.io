---
title: "**Module 2.1:** Choropleth Maps"
format:
  html:
    code-copy: false
---
...
## 2.1.0 &nbsp;&nbsp; Getting set up for datatool
...
:::{.callout-caution appearance="simple" icon=false title="2.1.3 Exercise"}
...
## 2.1.2 &nbsp;&nbsp; Using `datatool` for plotting
...
## 2.1.3 &nbsp;&nbsp; Using datatool for drawing
...
## 2.1.4 &nbsp;&nbsp; Using datatool with generated data
...
:::{.callout-caution appearance="simple" icon=false title="2.1.9 Exercise"}
...
## 2.1.7 &nbsp;&nbsp; Using datatool for maps: tilemaps
